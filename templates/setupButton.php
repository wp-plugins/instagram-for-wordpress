<?php
  ...
  <script>
    ...
    function openSetup<?php print $instance['db_id'] ?>() {      
      ...
      jQuery('.instagram-widget-admin-form input, .instagram-widget-admin-form select').change(function() {
        configureForm();
      });
    ...
    jQuery(document).ready(function() {      
      ...
      if (!window.configureForm) {
        window.configureForm = function() {
          //reset everything
          jQuery('#anotherUser').hide();
          jQuery('#tags').hide();
          jQuery('#gridOptions').hide();
          jQuery('.slideshowOptions').hide();
          
          if (jQuery('#display').val() == 'tags') {
            jQuery('#tags').show();
          }
          if (jQuery('#display').val() == 'user') {
            jQuery('#anotherUser').show();
          }
          if (jQuery('#method').val() == 'grid' || jQuery('#method').val() == 'grid-page') {
            jQuery('#gridOptions').show();
          } else if (jQuery('#method').val() == 'slideshow') {
            jQuery('.slideshowOptions').show();
          }          
        }
      }
